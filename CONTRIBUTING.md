...
3. If you haven't signed the CLA yet, the bot will provide a link.
4. Click the link, sign in with GitHub, and agree to the terms.
5. The bot will automatically update the PR status to green!
